...
parser.add_argument('--device-map', type=str,
                    default='', help='Device map to use')
parser.add_argument('--model', type=str,
                    default='cerebras/Cerebras-GPT-2.7B', help='Model to use')
parser.add_argument('--max-seq-length', type=int,
                    default=256, help='Max sequence length')
parser.add_argument('--micro-batch-size', type=int,
                    default=12, help='Micro batch size')
...
parser.add_argument('--lora-dropout', type=float,
                    default=0.01, help='LORA dropout')
parser.add_argument('--max-new-tokens', type=int,
                    default=80, help='Max new tokens')
